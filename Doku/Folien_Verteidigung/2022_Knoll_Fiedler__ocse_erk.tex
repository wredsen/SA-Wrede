...
\begin{frame}[t,fragile,label=trajektorienregelung_6]{\large Trajektorienfolgeregelung - Dynamische Rückführung}
	
	\begin{itemize}
		\item mit $\tilde{\bullet}$~-Größen nun Entkopplung und Stabilisierung analog der statischen Rückführung möglich:
		\begin{align*}
		...
		\end{align*}
		\item Anpassung der Trajektorienplanung ...
	\end{itemize}
