...
\begin{frame}[t,fragile,label=ModellEinzelkran]{\large Analytisches Modell Einzelkran}
	...
	\begin{textblock*}{80mm}[0.,0.](80mm,35mm)
		...
		\visible<4->{
			Virtuelle Arbeit und verallgemeinerte Kraft:
			\begin{itemize}
				\item $\mathbf{F}_1 =
...
\begin{frame}[t,fragile,label=ModellEinzelkran]{\large Analytisches Modell Einzelkran}
	...
	\begin{textblock*}{80mm}[0.,0.](80mm,25mm)
		...
		\visible<1->{
			\centering{Systemgleichungen aus LG2:}
			\begin{subequations}
...
\begin{frame}[t,fragile,label=ModellDoppelkran]{\large Analytisches Modell Doppelkran}
	\begin{textblock*}{80mm}[0.,0.](12mm,13mm)	
		\visible<1->{
