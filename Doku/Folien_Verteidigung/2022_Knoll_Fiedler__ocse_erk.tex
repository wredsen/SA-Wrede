...
\begin{center}
	\embedvideo{\includegraphics[width=95mm]{images/onion_skinned_picture}}{images/gantry_crane_trajectory.mp4}
\end{center}
...
\begin{frame}[t,fragile,label=trajektorienregelung_3]{\large Trajektorienfolgeregelung}
	...
	\begin{textblock*}{72mm}[0.,0.](12mm,30mm)
		\visible<1-1>{	
...
\begin{frame}[t,fragile,label=trajektorienregelung_4]{\large Trajektorienfolgeregelung}
	...
	\pause
	\begin{itemize}
		\item[$\rightarrow$] $\boldsymbol{\Lambda}$ nicht regulär, statische Rückführung also nicht anwendbar
	\end{itemize}
