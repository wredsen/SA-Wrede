...
% ======================
\kurzfassung{Zur Erhöhung der Robustheit und Adaptivität von Produktionsprozessen sollen Steuerungs- und Regelungsaufgaben auf verschiedene Recheneinheiten verteilt werden. Dazu wurde am Fraunhofer-Institut für Integrierte Schaltungen IIS ein Demonstratorsystem entwickelt, das einen miniaturisierten Brückenkran mit zwei unabhängigen Steuerungseinheiten nachbildet. An diesem kann die Leistungsfähigkeit verschiedener Regelungsansätze in Hinblick auf das Maß ihrer Verteiltheit und Kommunikationsmöglichkeiten der Steuerungen untersucht werden. 
	
Im Rahmen dieser Arbeit wurde ein analytisches Modell des Brückenkrans über den Lagrange-Formalismus hergeleitet. Das ermittelte nichtlineare Mehrgrößensystem ist auf differenzielle Flachheit untersucht worden. Auf Basis des dabei ermittelten flachen Ausgangs sind für eine zentrale Referenzregelstrategie Ausgangstrajektorien zur Überführung zwischen Ruhelagen geplant worden. Außerdem ist darüber eine Parametrisierung der Eingangsgrößen des Systems für eine Vorsteuerung möglich. Verschiedene Folgeregelungen wurden für Anfangsfehler in den Zustandskomponenten simulativ geprüft.}
