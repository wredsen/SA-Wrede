...
% ======================
\kurzfassung{Zur Erhöhung der Robustheit und Adaptivität von Produktionsprozessen sollen dabei Steuerungs- und Regelungsaufgaben auf verschiedene Recheneinheiten verteilt werden. Dazu wurde am Fraunhofer-Institut für Integrierte Schaltungen IIS ein Demonstratorsystem entwickelt, das einen miniaturisierten Brückenkran mit zwei unabhängigen Steuerungseinheiten nachbildet. An diesem kann die Leistungsfähigkeit verschiedener Regelungsansätze in Hinblick auf den Grad ihrer Verteiltheit und Kommunikationsmöglichkeiten der Steuerungen untersucht werden. 
	
Im Rahmen dieser Arbeit wurde ein analytisches Modell des Brückenkrans über den Lagrange-Formalismus hergeleitet. Das ermittelte nichtlineare Mehrgrößensystem wurde auf differenzielle Flachheit untersucht. Auf Basis des dabei ermittelten flachen Ausgangs wurden für eine zentrale Referenzregelstrategie Ausgangstrajektorien zur Überführung zwischen Ruhelagen geplant. Außerdem ist darüber eine Parametrisierung der Eingangsgrößen des Systems für eine Vorsteuerung möglich. Verschiedene Folgeregelungen wurden für Anfangsfehler in den Zustandskomponenten simulativ geprüft.}
{In order to increase the robustness and adaptivity of production processes, control tasks are to be distributed among different computing units. For this purpose, a demonstrator system was developed at the Fraunhofer Institute for Integrated Circuits IIS, that represents a miniaturized overhead crane with two independent control units. This system can be used to investigate the performance of different control approaches with regard to their degree of distribution and the communication possibilities of the control units. 
