...
Das DAE-System besitzt die Zustandsvariable $\pmb{y}$ mit
\begin{equation}
	y
	=
	\begin{pmatrix}
...
Somit wird unter Berücksichtigung der verallgemeinerten Stellkräfte $\tau$ die implizite DGL gebildet:
\begin{equation}
